...
completion = client.chat.completions.create(
  ...
  messages=[
    ...
    {"role": "user", "content": "Generate SNAC codes for an audio sample with the following waveforms: [{'freq': 440, 'waveform_type': 'sine', 'amplitude': 0.8}, {'freq': 880, 'waveform_type': 'square', 'amplitude': 0.6}]"}
  ]
)
